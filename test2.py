...
dictionary_6X6 = aruco.Dictionary_get(aruco.DICT_6X6_1000)
dictionary_7X7 = aruco.Dictionary_get(aruco.DICT_7X7_1000)
#默认cam参数
...
cv_file.release()
# ret, mtx, dist, rvecs, tvecs = cameraCalibration.Calibration()
